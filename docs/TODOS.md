...
| ---- | ------ | ----------- | --------- | ---------- |
| T1 | **State matrix doc** (loading / empty / error / partial per screen) | Needs first implemented routes | After MVP form chosen | [T1-STATE-MATRIX.md](./T1-STATE-MATRIX.md) (Epic E8) |
