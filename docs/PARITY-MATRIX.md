...
| Main / hub menu | `/` (Operations hub), shell nav | **Star Hotel** brand links to hub; Reservations, Rooms, Guests, Day sheet in header; folio linked from reservation detail per T2. |
