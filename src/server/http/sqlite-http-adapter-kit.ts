...
export type ExpressAsyncHandler = (req: Request, res: Response, next: NextFunction) => Promise<void>
...
export function createSqliteHttpAdapterKit(persistence: HotelSqlitePersistencePort): SqliteHttpAdapterKit {
